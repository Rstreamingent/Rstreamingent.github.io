...
class _MovieInfoPageState extends State<MovieInfoPage> {
  ...
  void _toggleFavorite() {
    ...
    if (isFavorite) {
      // Add to favorites
      FavoritesUtil.addToFavorites(widget.movieName, widget.poster);
    } else {
                        ...
                        children: [
                          IconButton(
                            onPressed: () {
                              ...
                              SharedPreferencesUtils.saveLastPausedPosition(widget.videoPath, 0);
                                ...
                                MaterialPageRoute(
                                  builder: (context) {
                                    return VideoPage(
                                      ...
                                      startingPosition: 0, // Start from the beginning
                                    );
                                  },
                                ),
                              );
